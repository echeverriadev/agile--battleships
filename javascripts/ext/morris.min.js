...
(function() {
    ...
    b = window.Morris = {}, a = jQuery, b.EventEmitter = function() {
        ...
        return h(c, a), c.prototype.init = function() {
            ...
            var b, c, d, e, f, g, h;
            var regex = /(\d+)/g
            var funds = this.options.data[a].y
            for (d = this.data[a], b = "<div class='morris-hover-row-label'>$ " + funds + "</div>", h = d.y, c = f = 0, g = h.length; g > f; c = ++f) e = h[c], b += "<div class='morris-hover-point' style='color: " + this.colorFor(d, c, "label") + "'>\n  " + this.options.labels[c] + ":\n  " + this.data[a].label + "\n</div>";
            ...
            var b, c, d, e, f, g;
            var shots = parseInt($('#shots').html(), 10);
            if(shots === 0){
                for (this.seriesPoints[a] = [], f = this.data.slice(0,1), g = [], d = 0, e = f.length; e > d; d++) c = f[d], b = null, null != c._y[a] && (b = this.drawLinePoint(c._x, c._y[a], this.colorFor(c, a, "point"), a)), g.push(this.seriesPoints[a].push(b));
            }else{
                for (this.seriesPoints[a] = [], f = this.data.slice(0, shots + 1 ), g = [], d = 0, e = f.length; e > d; d++) c = f[d], b = null, null != c._y[a] && (b = this.drawLinePoint(c._x, c._y[a], this.colorFor(c, a, "point"), a)), g.push(this.seriesPoints[a].push(b));
            }
            return g
            ...
            var shots = parseInt($('#shots').html(), 10);
            if(shots === 0)
                return b = 'M70.71875,24L71.90078125,151L95.0828125,151L107.26484375,151L119.446875,151L131.62890625,151L143.8109375,151L155.99296875,151L168.175,151L180.35703124999998,151L192.5390625,151L204.72109375,151L216.903125,151L229.08515624999998,151L241.2671875,151L253.44921875,151L265.63125,151L277.81328125,151L289.99531249999995,151L302.17734375,151L314.359375,151L326.54140625,151L338.7234375,151L350.90546875,151L363.0875,151L375.26953125,151L387.45156249999997,151L399.63359375,151L411.815625,151L423.99765625,151L436.1796875,151L448.36171874999997,151L460.54375,151L472.72578125,151L484.9078125,151L497.08984375,151L509.27187499999997,151L521.45390625,151L533.6359375,151L545.81796875,151L558,151', null !== b ? this.drawLinePath(b, this.colorFor(null, a, "line"), a) : void 0
            else
                return b = this.paths[a], null !== b ? this.drawLinePath(b, this.colorFor(null, a, "line"), a) : void 0
        }, c.createPath = function(a, c, d) {
            //x equal to x - 1
            if($('#shots').html() != 40){
                a[parseInt($('#shots').html()) + 1].x = a[parseInt($('#shots').html())].x
            }
            ...
            if(c === 0){
                return this.raphael.text(0, b, c).attr("font-size", this.options.gridTextSize).attr("font-family", this.options.gridTextFamily).attr("font-weight", this.options.gridTextWeight).attr("fill", this.options.gridTextColor)
            }else{
        ...
        return h(d, c), e = {
            ...
            var shots = parseInt($('#shots').html(), 10);
            if(shots === 0)
                return b = 'M70.71875,24L71.90078125,151L95.0828125,151L107.26484375,151L119.446875,151L131.62890625,151L143.8109375,151L155.99296875,151L168.175,151L180.35703124999998,151L192.5390625,151L204.72109375,151L216.903125,151L229.08515624999998,151L241.2671875,151L253.44921875,151L265.63125,151L277.81328125,151L289.99531249999995,151L302.17734375,151L314.359375,151L326.54140625,151L338.7234375,151L350.90546875,151L363.0875,151L375.26953125,151L387.45156249999997,151L399.63359375,151L411.815625,151L423.99765625,151L436.1796875,151L448.36171874999997,151L460.54375,151L472.72578125,151L484.9078125,151L497.08984375,151L509.27187499999997,151L521.45390625,151L533.6359375,151L545.81796875,151L558,151', null !== b ? (b += "L" + this.transX(this.xmax) + "," + this.bottom + "L" + this.transX(this.xmin) + "," + this.bottom + "Z", this.drawFilledPath(b, this.fillForSeries(a))) : void 0
            else 
